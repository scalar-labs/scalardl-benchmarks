...
public class DepositChecking extends JacksonBasedContract {
  ...
  public JsonNode invoke(
    ...
    int checkingBalance = data.get(Const.KEY_CHECKING_BALANCE).asInt();
    checkingBalance += amount;

    ObjectNode newData = data.deepCopy();
    newData.put(Const.KEY_CHECKING_BALANCE, checkingBalance);
